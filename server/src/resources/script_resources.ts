...
export function createScriptResource(getConnection: GetConnection = getGodotConnection): Resource {
  return {
      uri: 'godot/script',
...
export const scriptResource: Resource = createScriptResource();

/**
 * Resource that provides a list of all scripts in the project
 */
export function createScriptListResource(getConnection: GetConnection = getGodotConnection): Resource {
  return {
    uri: 'godot/scripts',
...
export const scriptListResource: Resource = createScriptListResource();

/**
 * Resource that provides metadata for a specific script, including classes and methods
 */
export function createScriptMetadataResource(getConnection: GetConnection = getGodotConnection): Resource {
  return {
